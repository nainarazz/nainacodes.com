...
![fishing rod](/static/images/basic-react-hooks-using-typescript/fishing-hook.jpg)

<ImageAttribution
  text="Photo by James Wheeler on Unsplash"
  url="https://unsplash.com/photos/HJhGcU_IbsQ"
/>
